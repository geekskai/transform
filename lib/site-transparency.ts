...
export const PRIVACY_DISCLOSURES = {
  ...
  analytics:
    "Folioify uses Microsoft Clarity for usage analytics and session replay, and Sentry for error monitoring, performance diagnostics, and session replay. These services may receive device, browser, network, interaction, and diagnostic data. Editor and input content is intended to be masked in replay data, but you should not submit sensitive content.",
  cookies:
    "Folioify and its analytics, monitoring, or advertising providers may use cookies and similar technologies to operate the site, understand usage, prevent abuse, and support advertising. Browser controls can be used to block or delete cookies.",
  advertising:
  ...
  vendors:
    "Third-party services currently used by Folioify include Microsoft Clarity, Sentry, Vercel for hosting and server-backed transformations, and Google AdSense when advertising is enabled. Each provider processes data under its own terms and privacy policy.",
